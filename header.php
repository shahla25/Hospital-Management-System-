...
<body>
<div class="wrapper col1" style="background-color: light blue">
  <div id="head"><br>
    <center><h1>Arogya Health Care hospital</h1></center>
    <div id="topnav" style="background-color: light blue">
      <ul>
